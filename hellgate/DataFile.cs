...
namespace Hellgate
{
    public abstract class DataFile
    {
        ...
        public static readonly Dictionary<String, DataFileAttributes> DataFileMap = new Dictionary<String, DataFileAttributes>
        {
            ...
            {"AFFIXES", new DataFileAttributes {RowType = typeof(Affixes), HasScriptTable = true, StructureId = 0x9DF76E6C}},
            ...
            {"CHAT_INSTANCED_CHANNELS", new DataFileAttributes {RowType = typeof(ChatInstancedChannels), HasScriptTable = true, StructureId = 0xDC35E3D0}},
            ...
            {"DAMAGE_EFFECTS", new DataFileAttributes {FileName = "DAMAGEEFFECTS", RowType = typeof(DamageEffects), HasScriptTable = true, StructureId = 0x26BC8A8D}},
            ...
            {"INVENTORY", new DataFileAttributes {RowType = typeof(Inventory), HasScriptTable = true, StructureId = 0x8FEEC9AC}},
            ...
            {"ITEM_LEVELS", new DataFileAttributes {RowType = typeof(ItemLevels), HasScriptTable = true, StructureId = 0xCE724D43}},
            ...
            {"ITEM_QUALITY", new DataFileAttributes {FileName = "ITEMQUALITY", RowType = typeof(ItemQuality), HasScriptTable = true, StructureId = 0x2D83EDCC}},
            {"ITEMS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x887988C4}},
            ...
            {"LOADING_TIPS", new DataFileAttributes {RowType = typeof(LoadingTips), HasScriptTable = true, StructureId = 0xF98A5E41}},
            ...
            {"MISSILES", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x887988C4}},
            ...
            {"MONSTERS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x887988C4}},
            ...
            {"PLAYERS", new DataFileAttributes {RowType = typeof(Items), HasScriptTable = true, HasStats = true, StructureId = 0x887988C4}},
            ...
            {"STATES", new DataFileAttributes {RowType = typeof(States), HasScriptTable = true, HasIndexBitRelations = true, StructureId = 0xFD6839DE}},
            ...
            {"TREASURE", new DataFileAttributes {RowType = typeof(Treasure), HasScriptTable = true, StructureId = 0x01A8DA81}},
        ...
        public static readonly Dictionary<String, DataFileAttributes> DataFileMapTestCenter = new Dictionary<String, DataFileAttributes>
        {
            ...
            {"AFFIXES", new DataFileAttributes {IsTCv4 = true, RowType = typeof(AffixesTCv4), HasScriptTable = true}},
            ...
            {"BADGE_REWARDS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(BadgeRewardsTCv4), HasScriptTable = true}},
            {"CHARACTER_CLASS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(CharacterClassTCv4)}},
            {"DAMAGE_EFFECTS", new DataFileAttributes {IsTCv4 = true, FileName = "DAMAGEEFFECTS", RowType = typeof(DamageEffectsTCv4), HasScriptTable = true}},
            {"DAMAGETYPES", new DataFileAttributes {IsTCv4 = true, RowType = typeof(DamageTypesTCv4)}},
            {"INVENTORY", new DataFileAttributes {IsTCv4 = true, RowType = typeof(InventoryTCv4), HasScriptTable = true}},
            {"ITEM_LOOKS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemLooksTCv4)}},
            {"ITEM_QUALITY", new DataFileAttributes {IsTCv4 = true, FileName = "ITEMQUALITY", RowType = typeof(ItemQualityTCv4), HasScriptTable = true}},
            {"ITEMS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasStats = true, HasScriptTable = true}},
            {"OBJECTS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasStats = true, HasScriptTable = true}},
            {"MONSTERS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasStats = true, HasScriptTable = true}},
            {"PLAYERS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasStats = true, HasScriptTable = true}},
            {"MISSILES", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasStats = true, HasScriptTable = true}},
            {"MATERIALS_COLLISION", new DataFileAttributes {IsTCv4 = true, RowType = typeof(MaterialsCollisionTCv4)}},
            {"LEVEL", new DataFileAttributes {IsTCv4 = true, FileName = "LEVELS", RowType = typeof(LevelsTCv4), HasScriptTable = true}},
            ...
            {"TREASURE", new DataFileAttributes {IsTCv4 = true, RowType = typeof(TreasureTCv4), HasScriptTable = true}},
