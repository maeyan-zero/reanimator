...
namespace Hellgate
{
    ...
    {
        public static String FilePath { get { return "excel\\"; } }
        public static String FileExtension { get { return ".txt.cooked"; } }
        ...
        static ExcelFile()
        {
            ...
            DataTypes.Add((UInt32)0xDC35E3D0, typeof(ChatInstancedChannel));
        ...
        private class Token
        {
            public const UInt32 Cxeh = 0x68657863;
            public const UInt32 Rcsh = 0x68736372;
            public const UInt32 Tysh = 0x68737974;
            public const UInt32 Mysh = 0x6873796D;
            public const UInt32 Dneh = 0x68656E64;
        }
        ...
        {
            public Boolean IsBitmask { get; set; }
            public Boolean IsBool { get; set; }
            public Boolean IsValueList { get; set; }
            public Boolean IsStringOffset { get; set; }
            public Boolean IsStringIndex { get; set; }
            public Boolean IsIntOffset { get; set; }
            public Boolean IsTableIndex { get; set; }
            public String TableStringID { get; set; }
            public UInt32 SortID { get; set; } // sort array position 1,2,3,4
            public Boolean SortDefault { get; set; } // include a blank row?
            public String SortType { get; set; } // distinct, preorder
        }
        ...
        public class ColumnKeys
        {
            ...
            public const String IsValueList = "IsValueList";
            ...
            public const String TableStringID = "TableStringID";
            public const String IsRelationGenerated = "IsRelationGenerated";
            public const String SortID = "SortID";
            public const String SortDefault = "SortDefault";
            public const String SortType = "SortType";
        }

        /// <summary>
        /// Compares a token against the offset position of the buffer.
        /// </summary>
        /// <param name="expected">The token to compare against.</param>
        /// <param name="buffer">The buffer to compare.</param>
        /// <param name="offset">To position in the buffer to comapre.</param>
        /// <returns>Returns true if the token matches.</returns>
        private Boolean CheckToken(UInt32 expected, Byte[] buffer, ref Int32 offset)
        {
            UInt32 token = Tools.ByteArrayToUInt32(buffer, ref offset);
            return (expected == token);
        }

        /// <summary>
        /// Gets the custom ExcelAttribute from the FieldInfo.
        /// </summary>
        /// <param name="fieldInfo">The FieldInfo to retrieve the attributes from.</param>
        /// <returns>Returns any ExcelAttributes found., otherwise null.</returns>
        public static ExcelAttribute GetExcelAttribute(FieldInfo fieldInfo)
        {
            return fieldInfo.GetCustomAttributes(typeof(ExcelAttribute), true).Length != 0 ?
                (ExcelAttribute)fieldInfo.GetCustomAttributes(typeof(ExcelAttribute), true).GetValue(0) : null;
        }
    }
}
