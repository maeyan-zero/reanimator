...
namespace Hellgate
{
    public abstract class DataFile
    {
        ...
        public static readonly Dictionary<String, DataFileAttributes> DataFileMapTestCenter = new Dictionary<String, DataFileAttributes>
        {
            ...
            {"ITEMS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasExtended = true}},
            {"OBJECTS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasExtended = true}},
            {"MONSTERS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasExtended = true}},
            {"PLAYERS", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasExtended = true}},
            {"MISSILES", new DataFileAttributes {IsTCv4 = true, RowType = typeof(ItemsTCv4), HasExtended = true}},
            ...
            {"ACHIEVEMENTSLOTS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"DONATION_REWARDS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"LOADING_SCREEN", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"PLAYERRANKS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"SOUNDMIXSTATESETS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"VERSIONINGAFFIXES", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"VERSIONINGUNITS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"CMD_MENUS", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"EMOTES", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}}, // todo: no definition
            {"RECIPE_PROPERTIES", new DataFileAttributes {IsTCv4 = true, IsEmpty = true}} // todo: no definition
        };
        ...
        public static readonly Dictionary<String, DataFileAttributes> DataFileMapResurrection = new Dictionary<String, DataFileAttributes>
        {
            ...
            {"ITEMS", new DataFileAttributes {RowType = typeof(ItemsBeta), HasExtended = true}},
            ...
            {"MISSILES", new DataFileAttributes {RowType = typeof(ItemsBeta), HasExtended = true}},
            {"MONSCALING_FIELDLEVEL", new DataFileAttributes {RowType = typeof(MonScalingFieldLevelBeta)}},
            {"MONSTERS", new DataFileAttributes {RowType = typeof(ItemsBeta), HasExtended = true}},
            {"OBJECTS", new DataFileAttributes {RowType = typeof(ItemsBeta), HasExtended = true, HasScriptTable = true}},
            ...
            {"PLAYERS", new DataFileAttributes {RowType = typeof(ItemsBeta), HasExtended = true}},
            {"PROPS", new DataFileAttributes {RowType = typeof(LevelsRoomIndexBeta)}},
            {"PVP", new DataFileAttributes {RowType = typeof(PvpBeta)}},
            {"PVP_ENTRY_CONDITION", new DataFileAttributes {RowType = typeof(PvpEntryConditionBeta)}},
