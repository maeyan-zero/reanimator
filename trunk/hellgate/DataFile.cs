...
namespace Hellgate
{
    public abstract class DataFile
    {
        ...
        {
            // Excel files
            {"ACHIEVEMENTS", new DataFileAttributes {RowType = typeof(Achievements)}},
            ...
            {"MONLEVEL", new DataFileAttributes {RowType = typeof(MonLevel)}},
            ...
            {"OBJECTS", new DataFileAttributes {RowType = typeof(Items), HasExtended = true}},
            ...
            {"PETLEVEL", new DataFileAttributes {RowType = typeof(MonLevel)}},
            {"PLAYERLEVELS", new DataFileAttributes {RowType = typeof(PlayerLevels)}},
            ...
            {"RARENAMES", new DataFileAttributes {RowType = typeof(RareNames)}},
