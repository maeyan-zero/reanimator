...
{
    internal class XmlAppearanceDefinition : XmlDefinition
    {
        private new static readonly XmlCookElement[] Elements =
        {
            ...
            new XmlCookElement
            {
                ...
                ChildType = typeof (XmlAnimationDefinition)
            },
            new XmlCookElement
            {
                Name = "tInitAnimation",
            ...
            new XmlCookElement
            {
                ...
                DefaultValue = 0,
                ElementType = ElementType.TableArrayVariable,
                ChildType = typeof (XmlInventoryViewInfo)
            },
            new XmlCookElement
            {
                Name = "fMaxRopeBendXY",
        ...
        public XmlAppearanceDefinition()
        {
