...
{
    public class SkillEventTypes : ExcelTable
    {
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        class SkillEventTypesTable
        {
	...
	8 bit uses include in ui count*/
        ...
        public SkillEventTypes(byte[] data) : base(data) { }

        protected override void ParseTables(byte[] data)
        {
            ReadTables<SkillEventTypesTable>(data, ref offset, Count);
        }
    }
}