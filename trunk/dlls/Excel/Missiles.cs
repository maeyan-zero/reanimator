...
{
    public class Missiles : ExcelTable
    {
      ...
      'retarget on bounce',4);*/
            ...
            public Int32 characterScreenWardrobe;//index
            public Int32 characterScreenState;//index
            public Int32 wardrobeBody;//index
            public Int32 wardrobeFallback;//index
            public Int32 wardrobeUnkown1;
            public Int32 wardrobeMip;
            public Int32 wardrobeAppearanceGroup;//index
        ...
        List<MissilesTable> missiles;

        public Missiles(byte[] data) : base(data) { }

        public override object GetTableArray()
        {
            return missiles.ToArray();
        }

        protected override void ParseTables(byte[] data)
        {
            missiles = ExcelTables.ReadTables<MissilesTable>(data, ref offset, Count);
        }
