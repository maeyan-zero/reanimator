...
{
    public class DamageEffects : ExcelTable
    {
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        class DamageEffectsTable
        {
            TableHeader header;
        ...
        public DamageEffects(byte[] data) : base(data) { }

        protected override void ParseTables(byte[] data)
        {
            ReadTables<DamageEffectsTable>(data, ref offset, Count);
        }
    }
}
