...
namespace Revival.Common
{
    static public class Export
    {
        ...
        static public string ArrayToCSV(byte[] data, char delimiter, Type castAs)
        {
        ...
        static public byte[] CSVtoArray(string data, char delimiter, Type castAs)
        {
            int castLen = Marshal.SizeOf(castAs);
            string typeName = castAs.Name;
            string[] explode = data.Split(delimiter);
