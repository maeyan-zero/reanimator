...
namespace Reanimator
{
    ...
    public class Unit
    {
        ...
        internal int unknownCount1B;									// 5
        internal UnknownCount1B_S[] unknownCount1Bs;			                        // no idea wtf these do either
        ...
        internal int unknownFlagValue;								    // 16
        ...
        internal int characteCount;									    // 8 bits
