...
namespace Reanimator
{
    public partial class ExcelFile
    {
        ...
        static ExcelFile()
        {
            ...
            DataTypes.Add((UInt32)0x01A8DA81, typeof(TreasureRow));
            DataTypes.Add((UInt32)0x03407879, typeof(AnimationGroupsRow));
            DataTypes.Add((UInt32)0x08402828, typeof(CharacterClassRow));
            DataTypes.Add((UInt32)0x102ECE59, typeof(AiStartRow));
            DataTypes.Add((UInt32)0x106C109C, typeof(AffixTypesRow));
            DataTypes.Add((UInt32)0x1EE32EF6, typeof(BonesRow));
            DataTypes.Add((UInt32)0x1F9DDC98, typeof(UnitTypesRow));
            DataTypes.Add((UInt32)0x26BC8A8D, typeof(DamageEffectsRow));
            DataTypes.Add((UInt32)0x2D83EDCC, typeof(ItemQualityRow));
            DataTypes.Add((UInt32)0x4319D23D, typeof(DisplayRow));
            DataTypes.Add((UInt32)0x45B08A9E, typeof(AnimationStanceRow));
            DataTypes.Add((UInt32)0x62ECA6E1, typeof(AchievementsRow));
            DataTypes.Add((UInt32)0x63F90CA5, typeof(BackGroundSounds3DRow));
            DataTypes.Add((UInt32)0x8A5FF6B8, typeof(AiBehaviourRow));
            DataTypes.Add((UInt32)0x7A7D891E, typeof(BudgetsModelRow));
            DataTypes.Add((UInt32)0x7F15F865, typeof(AiInitRow));
            DataTypes.Add((UInt32)0x86DC367C, typeof(BookMarksRow));
            DataTypes.Add((UInt32)0x8B84B802, typeof(ConditionFunctionsRow));
            DataTypes.Add((UInt32)0x904D8906, typeof(GameGlobalsRow));
            DataTypes.Add((UInt32)0x9DF76E6C, typeof(AffixesRow));
            DataTypes.Add((UInt32)0xAA0F158C, typeof(BadgeRewardsRow));
            DataTypes.Add((UInt32)0xAF168F4E, typeof(DialogRow));
            DataTypes.Add((UInt32)0xAFBF5906, typeof(AiCommonStateRow));
            DataTypes.Add((UInt32)0xB0DA4BE1, typeof(BackGroundSounds2DRow));
            DataTypes.Add((UInt32)0xBB554372, typeof(ActRow));
            DataTypes.Add((UInt32)0xBBC15A50, typeof(ColorSetsRow));
            DataTypes.Add((UInt32)0xBEE975EA, typeof(BudgetTextureMipsRow));
            DataTypes.Add((UInt32)0xD59E46B8, typeof(AnimationConditionRow));
            DataTypes.Add((UInt32)0xDC35E3D0, typeof(ChatInstancedChannelsRow));
            DataTypes.Add((UInt32)0xEAC1CAA4, typeof(DamageTypesRow));
