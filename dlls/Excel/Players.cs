...
{
    public class Players : ExcelTable
    {
      ...
      'retarget on bounce',4);*/
        ...
        List<PlayersTable> players;

        public Players(byte[] data) : base(data) { }
        ...
        {
            players = ExcelTables.ReadTables<PlayersTable>(data, ref offset, Count);
        }
