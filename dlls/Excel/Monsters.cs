...
{
    public class Monsters : ExcelTable
    {
      ...
      'retarget on bounce',4);*/
        ...
        List<MonstersTable> monsters;

        public Monsters(byte[] data) : base(data) { }
        ...
        {
            monsters = ExcelTables.ReadTables<MonstersTable>(data, ref offset, Count);
        }
