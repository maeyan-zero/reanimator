...
namespace Reanimator.Excel
{
    public class ExcelTables : ExcelTable
    {
            ...
            : base(data)
        {
            ...
            excelTables.AddTable("QUEST_STATE", "QUESTSTATE", typeof(Excel.QuestState));
            ...
            excelTables.AddTable("SOUNDVCASETS", null, typeof(Excel.SoundVcaSets));
            excelTables.AddTable("SPAWNCLASS", null, typeof(Excel.SpawnClass));
            ...
            excelTables.AddTable("STRINGSFILES", null, typeof(Excel.StringsFiles));
