...
{
    public class ObjectTriggers : ExcelTable
    {
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        class ObjectTriggersTable
        {
            TableHeader header;
        ...
        public ObjectTriggers(byte[] data) : base(data) { }

        protected override void ParseTables(byte[] data)
        {
            ReadTables<ObjectTriggersTable>(data, ref offset, Count);
        }
    }
}
